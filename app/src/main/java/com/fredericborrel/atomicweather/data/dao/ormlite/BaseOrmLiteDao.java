package com.fredericborrel.atomicweather.data.dao.ormlite;

import com.fredericborrel.atomicweather.AtomicWeather;
import com.fredericborrel.atomicweather.data.dao.BaseDao;
import com.fredericborrel.atomicweather.data.local.DatabaseHelper;
import com.fredericborrel.atomicweather.data.model.BaseEntity;
...
public abstract class BaseOrmLiteDao<T extends BaseEntity> implements BaseDao<T> {
    ...
    public BaseOrmLiteDao() {
        DatabaseHelper databaseHelper = OpenHelperManager.getHelper(AtomicWeather.context, DatabaseHelper.class);
        try {
